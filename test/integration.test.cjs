...
describe("Integración BashoodPresaleFinal: pagos, propuestas y roles", function () {
  ...
  it.skip("flujo completo: pago de servicio, propuesta y finalización - DEPRECATED: submitProposal/finalizeProposal removed", async function () {
    // Pago de servicio
  ...
  it.skip("bloquea todo si el contrato está pausado - DEPRECATED: submitProposal removed", async function () {
