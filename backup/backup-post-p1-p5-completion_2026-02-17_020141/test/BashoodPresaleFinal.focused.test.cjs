...
describe('BashoodPresaleFinal - focused branches', function () {
  ...
  it.skip('purchaseWithETH: success happy path and project wallet receive - TODO: ETH forwarding not implemented', async function () {
  ...
  // NOTE: Pull-payment removed - ETH now goes directly to projectWallet (PaymentSplitter)
  ...
  it.skip('rescue delegation failures when rescueContract not set or projectWallet reverts - DEPRECATED: delegateRescue* removed', async function () {
