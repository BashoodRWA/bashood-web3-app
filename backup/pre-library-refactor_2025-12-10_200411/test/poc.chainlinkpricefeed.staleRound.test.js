...
describe("PoC: ChainlinkPriceFeed - Stale Round Detection", function () {
    let priceFeed;
    let mockFeed;
    let owner;
    ...
    it("should REVERT when answeredInRound < roundId (stale oracle data)", async function () {
    ...
    it("should ACCEPT when answeredInRound >= roundId (fresh oracle data)", async function () {
    ...
    it("should REVERT in peekLatestPrice when answeredInRound < roundId", async function () {
        // Setup: Set a valid price first
